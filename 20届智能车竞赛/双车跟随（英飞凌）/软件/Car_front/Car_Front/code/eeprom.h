...
typedef enum
{
    ...
    para_error_k,para_dynamic_p_coef,para_dynamic_frontsight,para_round_p1_decrease,para_round_p2_decrease,
    para_round_size,para_startrow,para_down_round_speed,
    para_num
}parameter;
