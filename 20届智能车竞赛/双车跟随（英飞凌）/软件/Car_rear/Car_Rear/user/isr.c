...
IFX_INTERRUPT(cc60_pit_ch0_isr, CCU6_0_CH0_INT_VECTAB_NUM, CCU6_0_CH0_ISR_PRIORITY)
{
    ...
    if(!start_flag)
    {
//        motor_l.i=4*EEPROM_Read_Data(motor_l_i);
//        motor_r.i=4*EEPROM_Read_Data(motor_r_i);
    ...
    Speed_Loop();
//    printf("%.2f,%.2f,%.2f,%.2f\r\n",speed_L,speed_R,target_speed_L,target_speed_R);
//    printf("%.2f\r\n",speed_R);
...
IFX_INTERRUPT(cc61_pit_ch1_isr, CCU6_1_CH1_INT_VECTAB_NUM, CCU6_1_CH1_ISR_PRIORITY)
{
    ...
    {
//        motor_l.i=EEPROM_Read_Data(motor_l_i);
//        motor_r.i=EEPROM_Read_Data(motor_r_i);
        if(start_delay_count++==START_DELAY_TIME)
        {
            motor_l.out=motor_r.out=0;
            target_speed_pid.out=0;
            start_flag=1;
