        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if (((left_f - last_left_f)<= -15) and left_f == -53 and abs(right_f-road_width_f/2)<5):
                        sign_sci_l = 1
                    elif (((right_f - last_right_f) >= 15) and right_f == 53):
                        sign_sci_r = 1
                ...
                #左侧环岛
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if sign_sci_m == 0:
                            ...
                            if right_m == 53:
                                left_m = right_m - road_width_m*1.4
                            else:
                        ...
                        if sign_sci_f == 0:
                            ...
                            if right_f == 53:
                                left_f = right_f - road_width_f*1.4
                            else:
