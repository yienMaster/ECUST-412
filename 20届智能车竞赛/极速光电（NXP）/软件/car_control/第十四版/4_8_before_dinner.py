...
def time_pit_handler_1(time):
    global x, p, ticker_count, v_l, v_r
    ...
    ticker_count = (ticker_count + 1) if (ticker_count < 6) else (1)
    ...
    theita_add_l = ticker_count * follow_l / 6
    theita_add_r = ticker_count * follow_r / 6
