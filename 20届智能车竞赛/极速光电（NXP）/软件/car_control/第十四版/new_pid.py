...
def time_pit_handler_1(time):
    ...
    if theita_2_flag >= 5 and (theita_1 < 2.5 and theita_1 > 1.7) and (abs(theita_1 - theita_2) < 0.05):
        theita_2 = theita_1
        theita_2_flag = 0
    else:
    ...
    theita = theita_1 + 0.8 * (theita_2 - theita_1)
    ...
    if run_flag:
        ...
        if ticker_count % 2 == 0:
            pur_theita_l = pur_theita + v_out_l * round(ticker_count / 2 - 0.5) / 4
            pur_theita_r = pur_theita + v_out_r * round(ticker_count / 2 - 0.5) / 4
