...
def time_pit_handler_1(time):
    ...
    global stop_flag,theita_2_flag, theita_2_cre , w_z, theita_1_last, turn_count
    ...
    if run_flag:
        ...
        motor_duty_l = w_y_out_l - v_turn * turn_count / 3 + 120
        motor_duty_r = w_y_out_r + v_turn * turn_count / 3
