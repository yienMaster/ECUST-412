...
while True:
    ...
    if cal_flag :
        ...
        left_m, right_m, width_m = find_road(ccd_data2 , 60)
        left_f, right_f, width_f = find_road(ccd_data3 , 60)
        ...
        #print(1)
        wireless.send_oscilloscope(ticker_count)
        #wireless.send_oscilloscope(w_y_cal, w_y, theita_cal, theita)
        #wireless.send_oscilloscope(w_z_cal, w_z, omiga_cal , omiga)
