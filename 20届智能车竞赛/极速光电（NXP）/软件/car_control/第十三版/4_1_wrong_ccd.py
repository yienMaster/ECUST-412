...
while True:
    ...
    if cal_flag :
        ...
        if mode_1 == 1:
            #直行状态
            if mode_2 == 1:
                line_pos = (0.05 * (left_n + right_n) + 0.47 * (left_m + right_m) + 0.48 * (left_f + right_f))*(1/2) 
    ...
    '''
#if data_wave[0] != 0:
    kp_v_l = data_wave[2] * 0.00001
    kp_v_r = kp_v_l
         
#if data_wave[1] != 0:
    ki_v_l = data_wave[3] * 0.00000005
    ki_v_r = ki_v_l
    '''
    '''
#if data_wave[2] != 0:
