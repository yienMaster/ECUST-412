...
def time_pit_handler_1(time):
    ...
    if run_flag:
        ...
        if ticker_count % 10 == 0:
            ...
            if pur_v != 0:
                if abs(v_l) >= pur_v + 120 or abs(w_z_real) > 35:
                    stop_flag = 1
        ...
        if abs(encoder_l.get()) >= 400 or abs(encoder_r.get()) >= 400:
            dis_l_r = 0.6
        else:
            dis_l_r = 0.2
...
while True:
    ...
    if cal_flag :
        ...
        #wireless.send_oscilloscope(encoder_l.get(), encoder_r.get())
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if abs(road_width_f_now - 45) < 5:
                    road_width_f = road_width_f_now
                
                if abs(road_width_m_now - 65) < 5:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 == 0:
                        ...
                        if  (abs(road_width_m_now - 65) <= 30 and abs(left_m+right_m) <=15 and left_m > -50) and (abs(road_width_f_now - 45) <= 20 and abs(left_f+right_f) <= 15 and left_f > -40):
                    ...
                    if mode_4 == 0:
                        ...
                        if (abs(road_width_m_now - 65) <= 10 and abs(left_m+right_m) <=15 and right_m < 50) and (abs(road_width_f_now - 45) <= 10 and abs(left_f+right_f) <=15 and right_f < 40):
        ...
        if sta_screen == 1:
            ...
            if screen_change == 1:   
                ...
                lcd.str12(110,270,  "%5.1f"%dis_l_r, 0xFFFF)
