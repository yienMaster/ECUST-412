...
def time_pit_handler_2(time):
    global key_flag
    global key_count, run_flag, choose_flag, sta_1, sta_2, sta_3
    key_flag = True 
    ...
    if key_count == 100:
        ...
        if key_data[2]:
            choose_flag = (choose_flag + 1) if (choose_flag < 3) else (1)
            key.clear(3)
        if key_data[3]:
            if choose_flag == 1:
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    elif sta_3 == 1 and (((right_f - last_right_f) >= 8) and right_f >= 40 and abs(left_f+road_width_f/2)<10):
                        sign_sci_r = 1
                    ...
                    if mode_4 == 0:
                        ...
                        if abs(road_width_f_now - road_width_f) <= 10 and abs(left_f+right_f) <=5:
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if sign_sci_m == 1:
                            if left_m == -53:
                                right_m = left_m + road_width_m*0.7
                            else:
                        ...
                        if sign_sci_f == 1:
                            if left_f == -53:
                                right_f = left_f + road_width_f*0.7
                            else:
