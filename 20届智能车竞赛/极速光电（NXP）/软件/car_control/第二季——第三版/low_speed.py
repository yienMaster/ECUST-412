...
def time_pit_handler_1(time, PID , STA):
    ...
    global theita_cal,v_out_l , v_out_r, pur_w_y_l, pur_w_y_r
    global slow_flag, slow_count,pur_w_y_l, pur_w_y_r
    ...
    if run_flag:
        ...
        if ticker_count % 2 == 0:
            pur_theita_l = PID.pur_theita + v_out_l * round(ticker_count / 2 - 0.5) / 5
            pur_theita_r = PID.pur_theita + v_out_r * round(ticker_count / 2 - 0.5) / 5
            
            PID.in_theita_last_l, pur_w_y_l = theita_pid(pur_theita_l, theita_cal, kp_theita, kd_theita, PID.in_theita_last_l)
            PID.in_theita_last_r, pur_w_y_r = theita_pid(pur_theita_r, theita_cal, kp_theita, kd_theita, PID.in_theita_last_r)
            pur_w_y_l = -pur_w_y_l
            pur_w_y_r = -pur_w_y_r

        PID.integral_w_y_l,PID.in_w_y_last_l, w_y_out_l = w_y_pid(pur_w_y_l, w_y_cal, kp_w_y, ki_w_y, kd_w_y, PID.integral_w_y_l ,PID.in_w_y_last_l, PID.inte_w_y_limit)
        PID.integral_w_y_r,PID.in_w_y_last_r, w_y_out_r = w_y_pid(pur_w_y_r, w_y_cal, kp_w_y, ki_w_y, kd_w_y, PID.integral_w_y_r ,PID.in_w_y_last_r, PID.inte_w_y_limit)
        w_y_out_l = -w_y_out_l
        w_y_out_r = -w_y_out_r
...
def time_pit_handler_2(time, PID , STA):
    ...
    global key_count, run_flag, screen_num, screen_change, list_size, lcd
            ...
            if control_choose != 0:
                ...
                if list_now == 10:
                    ...
                    if list_pos == 1:
                        ...
                        PID.m_r = PID.m_r + control_choose * 0.1
                        PID.f_r = 1 - PID.m_r
                    elif list_pos == 6:
                        PID.m_l = PID.m_l + control_choose * 0.1
                        PID.f_l = 1 - PID.m_l
                    elif list_pos == 7:
...
while True:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        '''
                    if mode_4 != 4:
                        line_pos = (PID.m_l * (left_m + right_m) + PID.f_l * (left_f + right_f))*(1/2)
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        '''
                    if mode_4 != 4:
                        line_pos = (PID.m_r * (left_m + right_m) + PID.f_r * (left_f + right_f))*(1/2)
    ...
    if STA.sta_screen == 1:
        ...
        if list_now == 10:
            if screen_num == 1:
                lcd.clear(0x0000)
                lcd.str24(60, 0,  "MAIN_MENU", 0xFE19)
                
                lcd.str24(20, 40,  "ELE-SWITCH", 0xFFFF)
                lcd.str24(20, 80,  "Pur_Theita", 0xFFFF)
                lcd.str24(20, 120,  "FOLLOW_NUM", 0xFFFF)
                lcd.str24(20, 160, "CCD_Thres", 0xFFFF)
                lcd.str24(20, 200, "SPEED", 0xFFFF)
                lcd.str24(80, 290, "(@ w @)", 0x67A)
                lcd.str24(160, 80,  "{:>5.3f}".format(PID.pur_theita), 0xFFFF)
                lcd.str24(160, 160,  "{:>3d}".format(PID.CCD_thres), 0xFFFF)
            ...
            if screen_num == 1:
                lcd.clear(0x0000)
                lcd.str24(40, 0,  "2_1 ELE-SWITCH", 0xFE19)
            ...
            if screen_change == 1:
                ...
                if STA.sta_left_sci == 1:
                    lcd.str24(190, 40,  a, 0xFFFF)
                else:
                    lcd.str24(190, 40,  b, 0xFFFF)
                    
                if STA.sta_right_sci == 1:
                    lcd.str24(190, 80,  a, 0xFFFF)
                else:
                    lcd.str24(190, 80,  b, 0xFFFF)
                    
                if STA.sta_bar == 1:
                    lcd.str24(190, 120,  a, 0xFFFF)
                else:
                    lcd.str24(190, 120,  b, 0xFFFF)
                    
                if STA.sta_ramp == 1:
                    lcd.str24(190, 160,  a, 0xFFFF)
                else:
                    lcd.str24(190, 160,  b, 0xFFFF)
                    
                if STA.sta_stop == 1:
                    lcd.str24(190, 200,  a, 0xFFFF)
                else:
                    lcd.str24(190, 200,  b, 0xFFFF)
            ...
            if screen_num == 1:
                ...
                lcd.str24(40, 0,  "2_3 FOLLOW_NUM", 0xFE19)
                lcd.str16(15, 40,  "kp_turn", 0xFFFF)
                lcd.str16(15, 65,  "kd_turn", 0xFFFF)
                lcd.str16(15, 90,  "kd_turn_w", 0xFFFF)
                lcd.str16(15,115,  "m", 0xFFFF)
                lcd.str16(15,140,  "m_r_sci", 0xFFFF)
                lcd.str16(15,165,  "m_l_sci", 0xFFFF)
                lcd.str16(15,190,  "dis_l_r", 0xFFFF)
            ...
            if screen_change == 1:
                ...
                lcd.str16(170,140,  "%5.1f"%PID.m_r, 0xFFFF)
                lcd.str16(170,165,  "%5.1f"%PID.m_l, 0xFFFF)
                lcd.str16(170,190,  "%5.1f"%PID.dis_l_r, 0xFFFF)
            ...
            if screen_num == 1:
                ...
                lcd.str24(40, 0,  "2_6 SPEED", 0xFE19)
