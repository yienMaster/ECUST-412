...
#     out = ((v_real * v_real + 1)/ (v_pur * v_pur + 1) + 1 )* kp * offset - d_corrcte * kd * gyro
    out = math.log(1 + 0.3 * v_real ** 2 + 0.2 * v_pur ** 2) * kp * offset + 8800 * gyro +d_corrcte * kd * (in_now - in_last)
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 == 0:
                        ...
                        if  (abs(road_width_m_now - 70) <= 20 and abs(left_m+right_m) <=15 and left_m > -50) and (abs(road_width_f_now - 50) <= 15 and abs(left_f+right_f) <= 15 and left_f > -40):
