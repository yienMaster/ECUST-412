    ...
    if cal_flag :
        ...
        if mode_1 == 1:
            ...
            if sta_4 == 1 and sign_bar == 0 :
                bar_road_width_f = road_width_f * 35 / 45
                bar_road_width_m = road_width_m * 35 / 45
                
                if (abs(road_width_f_now - bar_road_width_f) <= 15) :
                    sign_bar = 1
                    if (abs(right_f - last_right_f) <= 10):
                        sign_bar_l = 1
                    elif (abs(left_f - last_left_f) <= 10):
                        sign_bar_r = 1
                    else:
                        sign_bar = 0
            elif 1 <= sign_bar <= 2:
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if abs(road_width_f_now - 40) < 5:
                    road_width_f = road_width_f_now
                
                if abs(road_width_m_now - 60) < 5:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 == 0:
                        ...
                        if  (abs(road_width_m_now - 60) <= 10 and abs(left_m+right_m) <=15 and left_m > -50) and (abs(road_width_f_now - 40) <= 10 and abs(left_f+right_f) <= 15 and left_f > -40):
                    ...
                    if mode_4 == 0:
                        ...
                        if (abs(road_width_m_now - 60) <= 10 and abs(left_m+right_m) <=15 and right_m < 50) and (abs(road_width_f_now - 40) <= 10 and abs(left_f+right_f) <=15 and right_f < 40):
