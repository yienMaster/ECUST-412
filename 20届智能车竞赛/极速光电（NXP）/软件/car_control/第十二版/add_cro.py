    ...
    if cal_flag :
        ...
        if mode_1 == 1:
            ...
            if sign_sci == 0:
                if (abs(road_width_f - sci_road_width_f_in) <= 5):
                    ...
                    if (left_f <= -48 and (abs(right_f - last_right_f) <= 3)):
                        sign_sci_l = 1
                    elif (right_f >= 48 and (abs(left_f - last_left_f) <= 3)):
                        sign_sci_r = 1
                    else:
                        sign_sci = 0
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                total_cro = 0.38 * sign_cro_n  + 0.47 * sign_cro_m + 0.15 * sign_cro_f
                line_pos = (0.38 * (left_n + right_n) * sign_cro_n  + 0.47 * (left_m + right_m) * sign_cro_m + 0.15 * (left_f + right_f) * sign_cro_f)*( total_cro /2) 
            '''
            if mode_2 == 3:
