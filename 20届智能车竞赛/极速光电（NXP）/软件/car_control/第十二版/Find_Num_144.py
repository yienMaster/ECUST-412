...
straight_road_width_n = 50
straight_road_width_m = 66
straight_road_width_f = 83
...
while True:
    ...
    if cal_flag :
        ...
        #75 60
        left_n, right_n, width_n = find_road(ccd_data1 , 83)
        #print(left_n, right_n)
        left_m, right_m, width_m = find_road(ccd_data2 , 66)
        left_f, right_f, width_f = find_road(ccd_data3 , 50)
        ...
        if mode_1 == 1:
            #直行状态
            if mode_2 == 1:
                line_pos = (0.25 * (left_n + right_n) + 0.45 * (left_m + right_m) + 0.3 * (left_f + right_f))*(1/2)
                ...
                if mode_3 == 1:
                    ...
                    if mode_4 == 0:
                        ...
                        if sign_sci_f == 1:
                            ...
                            if abs(road_width_f - straight_road_width_f) >= 20:
                                sci_num += 1
                                if sci_num == 2:
                                    sci_num = 0
                                    sign_sci_f = 0
                            ...
                            if sign_sci_m == 1:
                                ...
                                if abs(road_width_m - straight_road_width_m) >= 18:
                                    sci_num += 1
                                    if sci_num == 2:
                                        sci_num = 0
                                        sign_sci_m = 0
