...
def find_road(data, width):
    ...
    if find_l == 0 and find_r == 0:
        if left_edge == 64 and right_edge == 64:
            if data[70] > 20 and data[74] > 20 and data[80] > 20:
                left_edge = -53 + 64
                right_edge = 53 + 64
            else:
                left_edge =  64
...
sci_road_width_n_out = 0.5 * straight_road_width_n + 0.5 * total_road_width
sci_road_width_m_out = 0.5 * straight_road_width_m + 0.5 * total_road_width
sci_road_width_f_out = 0.5 * straight_road_width_f + 0.5 * total_road_width
...
while True:
    ...
    if cal_flag :
        ...
        if mode_1 == 1:
            ...
            if sign_sci == 0:
                if (abs(road_width_f - sci_road_width_f_in) <= 5) and (abs(road_width_m - straight_road_width_m) <= 3) and (abs(road_width_n - straight_road_width_n) <= 3):
                    sign_sci = 1
                ...
                if (abs(road_width_f - sci_road_width_f_in) <= 5) :
                    if sign_sci_l and (abs(right_f - straight_road_width_f / 2) <= 3):
                        sign_sci += 1
                    elif sign_sci_r and (abs(left_f + straight_road_width_f / 2) <= 3):
                        sign_sci += 1
                    else:
                        sign_sci = 0
                ...
                if (abs(road_width_m - sci_road_width_m_in) <= 5):
                    if (abs(road_width_f - total_road_width) <= 15):
                        sign_sci = 0
                        sign_sci_l = 0
                        sign_sci_r = 0
                    else:
                    ...
                    if mode_4 == 0:
                        ...
                        if sign_sci_f == 0:
                            ...
                            if sign_sci_m == 0:
                                ...
                                if abs(road_width_m - sci_road_width_m_out) <= 4:
                                    sci_num += 1
                                    if sci_num == 2:
                                        sci_num = 0
                                        sign_sci_m = 1
                                ...
                                if sign_sci_n == 0:
                                    if abs(road_width_n - sci_road_width_n_out) <= 5:
                                        sci_num += 1
                                        if sci_num == 2:
                                            sci_num = 0
                                            sign_sci_n = 1
        ...
        wireless.send_oscilloscope(mode_1,mode_2,mode_3, mode_4, road_width_n, road_width_m, road_width_f)
