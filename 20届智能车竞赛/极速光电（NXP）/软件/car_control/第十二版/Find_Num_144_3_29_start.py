...
while True:
    ...
    if cal_flag :
        ...
        if mode_1 == 1:
            #环岛检测
            if sign_sci == 0:
                if (abs(road_width_f - 80) <= 5):
                    sign_sci = 1
                    if (left_f <= -48 and (abs(right_f - 26) <= 3)):
                        sign_sci_l = 1
                    elif (right_f >= 48 and (abs(left_f + 26) <= 3)):
                        sign_sci_r = 1
                    
                    if (abs(right_f + left_f) <= 20):
                        sign_sci = 0
            elif sign_sci <= 4:
                if (abs(road_width_f - 80) <= 5) :
                    sign_sci += 1
                ...
                if mode_3 == 1:
                    ...
                    if mode_4 == 0:
                        ...
                        if sign_sci_f == 1:
                            ...
                            if abs(road_width_f - straight_road_width_f) <= 8:
                                sci_num += 1
                                if sci_num == 2:
                                    sci_num = 0
                                    sign_sci_f = 0
                            ...
                            if sign_sci_m == 1:
                                ...
                                if sign_sci_n == 1:
                                    if abs(road_width_n - straight_road_width_n) <= 10:
                                        sci_num += 1
                                        if sci_num == 2:
                                            sci_num = 0
                                            sign_sci_n = 0
                        ...
                        if sign_sci_f == 1:
                            ...
                            if road_width_f - straight_road_width_f >= 15:
                                sci_num += 1
                                if sci_num == 4:
                                    sci_num = 0
                                    sign_sci_f = 0
                            ...
                            if sign_sci_m == 1:
                                ...
                                if road_width_m - straight_road_width_m >= 30:
                                    sci_num += 1
                                    if sci_num == 3:
                                        sci_num = 0
                                        sign_sci_m = 0
                        ...
                        if sign_sci_f == 1:
                            ...
                            if sign_sci_m == 1:
                                ...
                                if abs(road_width_m - straight_road_width_m) <= 8:
                                    sign_sci_m = 0
