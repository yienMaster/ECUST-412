...
def run( v_turn ,v_l, v_r, theita_real, w_y_real):
    ...
    #wireless.send_oscilloscope(motor_duty_l,motor_duty_r, v_l, v_r ,pur_v_l, pur_v_r , kp_v_l * 100000 ,ki_v_l * 10000000)
...
def follow_road(line_pos,  w_z_real , v_l, v_r, theita_real, w_y_real):
    ...
    wireless.send_oscilloscope(v_turn, kp_1, kd_1, kp_2, kd_2, line_pos)
...
while True:
    ...
    if cal_flag :
        ...
        #left_f, right_f, width_f = find_road(ccd_data1)
        line_pos = left_n + right_n
