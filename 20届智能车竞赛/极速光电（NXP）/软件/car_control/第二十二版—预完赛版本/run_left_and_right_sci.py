...
while True:
    ...
    if cal_flag :
        ...
        #wireless.send_oscilloscope(left_m, right_m,left_f, right_f)
        #wireless.send_oscilloscope(left_m, right_m,left_f, right_f,mode_1,mode_3, mode_4,line_pos)
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if (((left_f - last_left_f)<= -15) and left_f == -53 and abs(right_f-road_width_f/2)<6):
                        sign_sci_l = 1

                    elif (((right_f - last_right_f) >= 8) and right_f >= 40 and abs(left_f+road_width_f/2)<10):
                        sign_sci_r = 1
