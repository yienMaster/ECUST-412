        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 1:
                    ...
                    if mode_4 != 3:
                        if sign_sci_m == 0:
                            right_m = left_m + straight_road_width_m+7
                        else:
                            left_m = right_m - straight_road_width_m-7
                        
                        if sign_sci_f == 0:
                            right_f = left_f + straight_road_width_f+7
                        else:
                            left_f = right_f - straight_road_width_f-7
