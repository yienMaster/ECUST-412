    ...
    if run_flag:
        ...
        if ticker_count % 10 == 0:
            ...
            if sign_i == 0:
                ...
                if v_l < 30:
                    integral_v_l, in_v_last_l, v_out_l = v_pid(real_pur_v, v_l, 2.2 * kp_v_l, 25 * ki_v_l, kd_v_l, integral_v_l, in_v_last_l, inte_v_limit)
                    integral_v_r, in_v_last_r, v_out_r = v_pid(real_pur_v, v_r, 2.2 * kp_v_r, 25 * ki_v_r, kd_v_r, integral_v_r, in_v_last_r, inte_v_limit)
                else:
    ...
    if cal_flag :
        ...
        if mode_1 == 1:
            ...
            if sta_4 == 1 and sign_bar == 0 :
                ...
                if (abs(road_width_f_now - bar_road_width_f) <= 10) :
                    sign_bar += 1
                elif abs(road_width_f_now - road_width_f) <= 10:
                    sign_bar = 0
            else:
                if abs(road_width_m_now - bar_road_width_m) <= 10:
                    sign_bar = 0
                    mode_1 = 2
                    mode_2 = 2
                    if sign_bar_l == 1:
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if sta_2 == 1 and (((left_f - last_left_f)<= -10) and left_f == -53 and abs(right_f-road_width_f/2)<6):
                        sign_sci_l = 1
