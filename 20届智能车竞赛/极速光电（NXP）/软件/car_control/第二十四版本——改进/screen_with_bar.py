...
#     out = ((v_real * v_real + 1)/ (v_pur * v_pur + 1) + 1 )* kp * offset - d_corrcte * kd * gyro
    out = math.log(1 + 0.3 * v_real ** 2 + 0.2 * v_pur ** 2) * kp * offset + 7800 * gyro +d_corrcte * kd * (in_now - in_last)
    ...
    if cal_flag :
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if abs(road_width_f_now - bar_road_width_f) <= 6:
                    sign_bar_f = 1
                else:
                    sign_bar_f = 0
                    
                if abs(road_width_m_now - bar_road_width_m) <= 6:
                    sign_bar_m = 1
                    sign_bar_out = 1
                else:
                    sign_bar_m = 0
