...
def follow_line(pur, data, gyro , kp, kd, d_corrcte_last, v_l, v_r, v_pur , in_last):
    ...
    in_now = pur - data
    offset = in_now * in_now * in_now / 8000 + in_now * 0.075
...
def time_pit_handler_1(time):
    ...
    if run_flag:
        ...
        if ticker_count % 10 == 0:
            ...
            if pur_v != 0:
                if abs(v_l) >= pur_v + 120 or abs(w_z_real) > 30:
                    stop_flag = 1
            ...
            if sign_i == 0:
                integral_v_l, in_v_last_l, v_out_l = v_pid(real_pur_v, v_l, 1.2 * kp_v_l, 30 * ki_v_l, kd_v_l, integral_v_l, in_v_last_l, inte_v_limit)
                integral_v_r, in_v_last_r, v_out_r = v_pid(real_pur_v, v_r, 1.2 * kp_v_r, 30 * ki_v_r, kd_v_r, integral_v_r, in_v_last_r, inte_v_limit)
            else:
                if v_l < 30:
...
while True:
    ...
    if cal_flag :
        ...
        #wireless.send_oscilloscope(mode_1, mode_2, mode_3, mode_4, left_m, right_m,left_f, right_f)
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if sign_sci_m == 0:
                            if left_m == -53:
                                right_m = left_m + road_width_m*1.25
                            else:
                                right_m = left_m + road_width_m*1.2
                        else:
                            if right_m == 53:
                                left_m = right_m - road_width_m*0.67
                            else:
                        ...
                        if sign_sci_f == 0:
                            ...
                            if right_f == 53:
                                left_f = right_f - road_width_f*0.67
                            else:
