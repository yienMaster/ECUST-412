...
while True:
    ...
    if cal_flag :
        ...
        wireless.send_oscilloscope(mode_1,mode_2,mode_3,sign_bar_f ,sign_bar_m,road_width_f_now,road_width_m_now)
        #位姿解算
        mx = imu_data[6] + 6275
        my = imu_data[7] + 123 
        mz = imu_data[8] - 132
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if (((left_f - last_left_f)<= -15) and left_f == -53 and abs(right_f-road_width_f/2)<6):
                        sign_sci_l = 1
                    '''    
                    elif (((right_f - last_right_f) >= 15) and right_f == 53 and abs(left_f-road_width_f/2)<6):
                        #sign_sci_r = 1 #(这里会检测到右环岛，先注释掉，强制恢复)
                    '''
                    if sign_sci_l == 1:
                        mode_3 = 1
                        sign_sci_m = 1
