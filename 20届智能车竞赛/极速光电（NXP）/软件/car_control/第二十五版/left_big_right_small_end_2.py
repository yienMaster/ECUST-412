...
#     out = ((v_real * v_real + 1)/ (v_pur * v_pur + 1) + 1 )* kp * offset - d_corrcte * kd * gyro
    out = math.log(1 + 0.3 * v_real ** 2 + 0.2 * v_pur ** 2) * kp * offset + 9400 * gyro +d_corrcte * kd * (in_now - in_last)
    ...
    if run_flag:
        ...
        if ticker_count % 10 == 0:
            ...
            if sign_i == 0:
                ...
                if v_l < 30:
                    integral_v_l, in_v_last_l, v_out_l = v_pid(real_pur_v, v_l, 2.5 * kp_v_l, 25 * ki_v_l, kd_v_l, integral_v_l, in_v_last_l, inte_v_limit)
                    integral_v_r, in_v_last_r, v_out_r = v_pid(real_pur_v, v_r, 2.5 * kp_v_r, 25 * ki_v_r, kd_v_r, integral_v_r, in_v_last_r, inte_v_limit)
                else:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if sign_sci_m == 0:
                            if left_m == -53:
                                ...
                                right_m = left_m + road_width_m*1.0
                        else:
                            if right_m == 53:
                        ...
                        if sign_sci_f == 0:
                            if left_f == -53:
                                ...
                                right_f = left_f + road_width_f*1.0
                        else:
                            if right_f == 53:
                    ...
                    if mode_4 == 0:
                        ...
                        if (abs(road_width_m_now - 70) <= 15 and abs(left_m+right_m) <=10 and right_m < 45) or (abs(road_width_f_now - 50) <= 20 and abs(left_f+right_f) <=10 and right_f < 35):
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if sign_sci_m == 1:
                            ...
                            if right_m == 53:
                                left_m = right_m - road_width_m*1.2
                            else:
                                left_m = right_m - road_width_m*1.1
                        ...
                        if sign_sci_f == 1:
                            ...
                            if right_f == 53:
                                left_f = right_f - road_width_f*1.2
                            else:
                                left_f = right_f - road_width_f*1.1
