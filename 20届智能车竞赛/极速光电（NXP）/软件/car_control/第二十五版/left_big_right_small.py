...
#     out = ((v_real * v_real + 1)/ (v_pur * v_pur + 1) + 1 )* kp * offset - d_corrcte * kd * gyro
    out = math.log(1 + 0.3 * v_real ** 2 + 0.2 * v_pur ** 2) * kp * offset + 8000 * gyro +d_corrcte * kd * (in_now - in_last)
...
while True:
    ...
    if cal_flag :
        ...
        wireless.send_oscilloscope(mode_4, mode_2, line_pos, left_m, right_m, left_f, right_f)
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 == 0:
                        ...
                        if  (abs(road_width_m_now - 70) <= 20 and abs(left_m+right_m) <=30 and left_m > -40) or (abs(road_width_f_now - 50) <= 20 and abs(left_f+right_f) <=20 and left_f > -35):
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if sign_sci_f == 0:
                            if left_f == -53:
                                right_f = left_f + road_width_f*1.35
                            else:
                    ...
                    if mode_4 == 0:
                        ...
                        if (abs(road_width_m_now - 70) <= 20 and abs(left_m+right_m) <=30 and right_m < 45) or (abs(road_width_f_now - 50) <= 25 and abs(left_f+right_f) <=20 and right_f < 35):
