...
def time_pit_handler_1(time):
    ...
    if run_flag:
        ...
        if ticker_count % 10 == 0:
            ...
            if sign_i == 0:
                integral_v_l, in_v_last_l, v_out_l = v_pid(real_pur_v, v_l, 1.4 * kp_v_l, 90 * ki_v_l, kd_v_l, integral_v_l, in_v_last_l, inte_v_limit)
                integral_v_r, in_v_last_r, v_out_r = v_pid(real_pur_v, v_r, 1.4 * kp_v_r, 90 * ki_v_r, kd_v_r, integral_v_r, in_v_last_r, inte_v_limit)
            else:
...
while True:
    ...
    if cal_flag :
        ...
        #wireless.send_oscilloscope(left_m, right_m,left_f, right_f,mode_1, mode_4,line_pos)
        ...
        if mode_1 == 1:
            ...
            if sign_sci == 0:
                ...
                if (abs(road_width_f_now - sci_road_width_f_in) <= 8) and line_pos < 10:
                    sign_sci = 1
                    '''
                    if (((left_f - last_left_f)<= -20) and left_f == -53 and (abs(right_f - last_right_f) <= 3)) and abs(road_width_f/2 - right_f) <= 3:
                        sign_sci_l = 1
                        left_f = right_f - road_width_f
                        left_m = right_m - road_width_m
                    '''
                    if (((left_f - last_left_f)<= -20) and left_f == -53 and abs(road_width_f/2 - right_f) <= 8):
                        sign_sci_l = 1
                        left_f = right_f - road_width_f
                        left_m = right_m - road_width_m
                    elif (((right_f - last_right_f) >= 20) and right_f == 53 and (abs(left_f - last_left_f) <= 3)) and abs(road_width_f/2 + left_f) <= 3:
                        sign_sci_r = 1
                ...
                if (abs(road_width_f_now - sci_road_width_f_in) <= 10) :
                    sign_sci += 1
                    if sign_sci_l == 1:
                        left_f = right_f - road_width_f
                        left_m = right_m - road_width_m
                ...
                if (abs(road_width_m_now - sci_road_width_m_in) <= 10):
                    sign_sci = 0
                    mode_1 = 2
                    mode_2 = 1
                    mode_4 = 0
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if abs(road_width_f_now - 40 ) < 8:
                    road_width_f = road_width_f_now
                
                if abs(road_width_m_now - 60) < 8:
                ...
                if mode_3 == 1:
                    ...
                    if mode_4 == 0:
                        ...
                        if sign_sci_f == 1:
                            ...
                            if abs(road_width_f_now - road_width_f) <= 5:
                                sci_num += 1
                                if sci_num == 2:
                                    sci_num = 0
                                    sign_sci_f = 0
                            ...
                            if sign_sci_m == 1:
                                ...
                                if abs(road_width_m_now  - road_width_m) <= 5:
                                    sci_num += 1
                                    if sci_num == 2:
                                        sci_num = 0
                                        sign_sci_m = 0
                        ...
                        if sci_num <= 2:
                            ...
                            if right_m == 53:
                                ...
                                if sci_num == 5:
                                    ...
                                    mode_4 = 4
                        '''
                        if road_width_m_now == 106 and road_width_f_now == 106:
                            sci_num += 1
                            if sci_num == 2:
                                sign_sci_f = 0
                                sign_sci_m = 0
                        ...
                        if sci_num <= 2:
                            if left_f <= -road_width_f/2 - 5:
                                sci_num += 1
                                    
                        elif sci_num >= 3:
                            if left_m <= -road_width_m/2 - 5:
                                sci_num += 1
                                if sci_num == 5:
                                    sci_num = 0
                                    sign_sci_f = 1
                    ...
                    wireless.send_oscilloscope(left_m, right_m,left_f, right_f,mode_1, mode_4,road_width_m,road_width_f)
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if sign_sci_m == 0:
                            if left_m == -53:
                                right_m = left_m + road_width_m*1.3
                            else:
                                right_m = left_m + road_width_m
                        else:
                            if right_m == 53:
                                left_m = right_m - road_width_m*1.3
                            else:
                                left_m = right_m - road_width_m
                        
                        if sign_sci_f == 0:
                            if left_f == -53:
                                right_f = left_f + road_width_f*1.3
                            else:
                                right_f = left_f + road_width_f
                        else:
                            if right_f == 53:
                                left_f = right_f - road_width_f*1.3
                            else:
                                left_f = right_f - road_width_f
                        '''
                    elif mode_4 == 3:
                        ...
                        #right_m = left_m + road_width_m*1.5

                        #right_f = left_f + road_width_f*1.5
