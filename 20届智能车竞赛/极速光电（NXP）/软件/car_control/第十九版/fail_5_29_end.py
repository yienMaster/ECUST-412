        ...
        if mode_1 == 1:
            ...
            if sign_sci == 0:
                ...
                if (abs(road_width_f_now - sci_road_width_f_in) <= 5):
                    ...
                    elif (((right_f - last_right_f) >= 10) and right_f == 53 and (abs(left_f - last_left_f) <= 3)) and abs(road_width_f/2 + left_f) <= 3:
                        sign_sci_r = 1
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 1:
                    ...
                    if mode_4 == 0:
                        ...
                        if road_width_f_now == 106 and road_width_m_now == 106:
                            mode_4 = 4
