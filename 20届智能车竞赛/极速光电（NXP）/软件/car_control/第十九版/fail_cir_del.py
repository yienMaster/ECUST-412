        ...
        if mode_1 == 1:
            ...
            if sign_sci == 0:
                ...
                if (abs(road_width_f_now - sci_road_width_f_in) <= 10):
                    ...
                    if (((left_f - last_left_f) <= -10) and left_f == -53 and (abs(right_f - last_right_f) <= 3)) and abs(road_width_f/2 - right_f) <= 3:
                        sign_sci_l = 1
                        left_f = right_f - road_width_f
                        left_m = right_m - road_width_m
                    # 右边环岛待完善
                    elif (((right_f - last_right_f) >= 10) and right_f >= 50 and (abs(left_f - last_left_f) <= 3)) and abs(road_width_f/2 + left_f) <= 3:
                        sign_sci_r = 1
        ...
        if mode_1 == 1:
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 1:
                    ...
                    wireless.send_oscilloscope(left_m, right_m,left_f, right_f,road_width_m ,road_width_f,mode_1, mode_4)
