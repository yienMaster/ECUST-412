            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if (abs(road_width_f_now - sci_road_width_f_in) <= 10):
                        ...
                        if (((left_f - last_left_f)<= -10) and left_f == -53):
                            sign_sci_l = 1
                        elif (((right_f - last_right_f) >= 10) and right_f == 53):
                            sign_sci_r = 1
                ...
                #左侧环岛
                    ...
                    if mode_4 == 0:
                        ...
                        if abs(road_width_f_now - road_width_f) <= 10 and (left_f+right_f) <=5:
                    ...
                    if mode_4 != 3 and mode_4 != 4 and mode_4 != 5:
                        ...
                        if abs(left_m - last_left_m ) >= 40:
                            left_m = last_left_m
                        if abs(right_m - last_right_m ) >= 40:
                            right_m = last_right_m
                            
                        if abs(left_f - last_left_f ) >= 40:
                            left_f = last_left_f
                        if abs(right_f - last_right_f ) >= 40:
                            right_f = last_right_f
