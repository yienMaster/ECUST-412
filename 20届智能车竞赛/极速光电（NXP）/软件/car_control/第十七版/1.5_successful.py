...
#     out = ((v_real * v_real + 1)/ (v_pur * v_pur + 1) + 1 )* kp * offset - d_corrcte * kd * gyro
    out = math.log(1 + 0.1 * v_real ** 2 + 0.4 * v_pur ** 2) * kp * offset + 3200 * gyro +d_corrcte * kd * (in_now - in_last)
...
def time_pit_handler_1(time):
    ...
    global in_dis_last, v_turn, line_pos, d_corrcte_last,v_turn_last
