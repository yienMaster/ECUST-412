...
def follow_line(pur, data, gyro , kp, kd, kd_w_z, d_corrcte_last, v_l, v_r, v_pur , in_last):
    ...
    in_now = pur - data
    offset = in_now * in_now * in_now / 6800 + in_now * 0.075
...
def time_pit_handler_1(time):
    ...
    if run_flag:
        ...
        if abs(line_pos) >= 8 and (abs(encoder_l.get()) >= 170 or abs(encoder_r.get()) >= 170):
            dis_jump = 0.7
        else:
            dis_jump = 1
            ...
            if mode_2 == 1:
                ...
                if mode_3 == 0:
                    ...
                    if mode_4 != 4:
                        ...
                        line_pos = - 15.5* (1/30) * (30 - sci_mode_5_num) + sci_mode_5_num * (m_l * (left_m + right_m) + f_l * (left_f + right_f))*(1/2) * (1/30)
